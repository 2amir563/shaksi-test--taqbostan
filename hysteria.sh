#!/bin/bash
# Optimized for installation using Personal GitHub Links
set -Eeuo pipefail
...
if [ ! -f "/usr/local/bin/hysteria" ]; then
  colorEcho "Downloading Hysteria binary from GitHub..." cyan
...
if [ ! -f /etc/hysteria/hysteria-monitor.py ]; then
  colorEcho "Downloading Monitoring script from GitHub..." cyan
